...
impl VirtualPool {
    pub fn initialize(
        ...
        self.migration_end_timestamp = migration_end_timestamp;
    }
    ...
    pub fn is_migration_deadline_reached(&self, current_timestamp: u64) -> bool {
        self.migration_end_timestamp != 0 && current_timestamp >= self.migration_end_timestamp
    }

    pub fn is_sale_complete(&self, migration_threshold: u64, current_timestamp: u64) -> bool {
        self.is_curve_complete(migration_threshold)
            || self.is_migration_deadline_reached(current_timestamp)
    }
