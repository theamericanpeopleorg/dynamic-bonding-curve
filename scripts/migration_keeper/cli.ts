...
export function usage() {
  console.log(`Usage:
  pnpm exec tsx scripts/migration_keeper.ts <POOL_PUBKEY> --damm-config <DAMM_V2_CONFIG> [--rpc-url <URL>] [--dbc-program-id <PROGRAM_ID>] [--keypair <PATH>]
...
Defaults:
  DBC Program ID: ${DYNAMIC_BONDING_CURVE_PROGRAM_ID.toBase58()}
